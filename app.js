...
if (STORE.pageState === "page4") {
    ...
    $('.js-score-container').html(`<p class="js-score-text">You got ${STORE.correctQuestions} of ${STORE.totalQuestions} questions!</p> <button type="submit">Play Again</button>`)
  }
...
function handleQuestionsPage() {
      ...
      $('.js-quiz-selection').on("click", ".js-final-answer", function (event) {
        event.preventDefault();
        finalAnswer = $('input[type="radio"]:checked').val()
